...
func (fs *DummyFs) Abs(path string) (string, error) {
...
func (fs *DummyFs) Base(path string) string {
...
func (fs *DummyFs) Clean(path string) string {
...
// If there is an error, it will be of type *PathError.
func (fs *DummyFs) Create(name string) (avfs.File, error) {
...
func (fs *DummyFs) Dir(path string) string {
...
func (fs *DummyFs) FromSlash(path string) string {
...
// permissions.
func (fs *DummyFs) GetTempDir() string {
	return avfs.TmpDir
}

// GetUMask returns the file mode creation mask.
func (fs *DummyFs) GetUMask() os.FileMode {
	return 0
}
...
// is malformed.
func (fs *DummyFs) Glob(pattern string) (matches []string, err error) {
	return fsutil.Glob(fs, pattern)
}

// IsAbs reports whether the path is absolute.
func (fs *DummyFs) IsAbs(path string) bool {
...
func (fs *DummyFs) IsExist(err error) bool {
...
func (fs *DummyFs) IsNotExist(err error) bool {
	return fsutil.IsNotExist(err)
}

// IsPathSeparator reports whether c is a directory separator character.
func (fs *DummyFs) IsPathSeparator(c uint8) bool {
...
func (fs *DummyFs) Join(elem ...string) string {
...
// If there is an error, it will be of type *PathError.
func (fs *DummyFs) Open(name string) (avfs.File, error) {
...
func (fs *DummyFs) ReadDir(dirname string) ([]os.FileInfo, error) {
...
// to be reported.
func (fs *DummyFs) ReadFile(filename string) ([]byte, error) {
...
func (fs *DummyFs) Rel(basepath, targpath string) (string, error) {
...
func (fs *DummyFs) SameFile(fi1, fi2 os.FileInfo) bool {
	return false
}
...
func (fs *DummyFs) TempDir(dir, prefix string) (name string, err error) {
...
func (fs *DummyFs) TempFile(dir, pattern string) (f avfs.File, err error) {
...
func (fs *DummyFs) ToSlash(path string) string {
...
func (fs *DummyFs) UMask(mask os.FileMode) {
	_ = mask
}
...
func (fs *DummyFs) Walk(root string, walkFn filepath.WalkFunc) error {
...
func (fs *DummyFs) WriteFile(filename string, data []byte, perm os.FileMode) error {
