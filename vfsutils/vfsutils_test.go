...
func TestRndTree(t *testing.T) {
	...
	t.Run("RndTreeMain", func(t *testing.T) {
		rtrTests := []struct {
			...
			{params: vfsutils.RndTreeParams{MinDepth: 0, MaxDepth: 0}, wantErr: vfsutils.ErrDepthOutOfRange},
			{params: vfsutils.RndTreeParams{MinDepth: 1, MaxDepth: 0}, wantErr: vfsutils.ErrDepthOutOfRange},
			{params: vfsutils.RndTreeParams{MinDepth: 1, MaxDepth: 1, MinName: 0, MaxName: 0}, wantErr: vfsutils.ErrNameOutOfRange},
			{params: vfsutils.RndTreeParams{MinDepth: 1, MaxDepth: 1, MinName: 1, MaxName: 0}, wantErr: vfsutils.ErrNameOutOfRange},
			{params: vfsutils.RndTreeParams{
			...
			}, wantErr: vfsutils.ErrFileLenOutOfRange},
			{params: vfsutils.RndTreeParams{
				MinDepth: 1, MaxDepth: 1, MinName: 1, MaxName: 1,
				MinFileLen: 1, MaxFileLen: 0,
			}, wantErr: vfsutils.ErrFileLenOutOfRange},
